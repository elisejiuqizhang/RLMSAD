...
Pretrain and save each model:
  <pre><code> $ python base_detectors/PyOD_models/ECOD_train.py<pre><code>
  
  <pre><code>$ python base_detectors/PyOD_models/COPOD_train.py<pre><code>
  
  <pre><code>$ python base_detectors/sklearn_models/OSVM_train.py<pre><code>
  
  <pre><code>$ python base_detectors/sklearn_models/iForest_train.py</code></pre>
